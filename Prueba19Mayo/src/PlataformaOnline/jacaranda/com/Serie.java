...
/*
 * se ha optado por un LinkedList ya que necesitamos mantener un orden y no nos importa que tengan elementos repetidos. 
 */
...
public class Serie {
	...
	public String listadoTemporadasPorNotaMedia() {
		...
		List<Temporada> tempAux = this.temporadas;

		Collections.sort(tempAux, new CompararPorNotaMedia());

		return tempAux.toString();
	}
	...
	public String listadoTemporadasPorNumeroDeCapitulos() {
		...
		Collections.sort(tempAux, new CompararPorNumCapitulos());
