...
public class Equipo {
	...
	// Borrar un alumno (recibe como parÃ¡metro el objeto alumno a borrar).
	// Si el alumno no existe en el equipo debe saltar una excepciÃ³n.
...
//	Saber si un alumno pertenece al equipo. Recibe como parÃ¡metro el objeto alumno a buscar 
