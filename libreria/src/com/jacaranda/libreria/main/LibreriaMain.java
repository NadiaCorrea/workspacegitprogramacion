...
//		utilice la funci�n anterior.
//		El programa principal tambi�n deber� pedir los datos para crear dos libros en papel y dos libros
//		digitales, los imprima y use los m�todos de ver cual es m�s caro.
		...
		try {
			System.out.println("�El primer libro en papel es m�s caro que el primer libro digital?: "
					+ libroPapel1.esMasCaro(libroDigital1));
			System.out.println("�El primer libro en papel es m�s caro que el segundo libro digital?: "
					+ libroPapel1.esMasCaro(libroDigital2));
			System.out.println("�El primer libro digital es m�s caro que el segundo libro en papel?: "
					+ libroDigital1.esMasCaro(libroPapel2));
			System.out.println("�El segundo libro digital es m�s caro que el segundo libro en papel?: "
	...
	public static Libro leerLibro() {
		...
		String titulo = leerCadena("Introduce el t�tulo: ");
		String autor = leerCadena("Introduce el autor: ");
		String editorial = leerCadena("Introduce la editorial: ");
		LocalDate fechaEdicion = leerFecha("Introduce la fecha de edici�n: ");
